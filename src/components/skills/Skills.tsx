...
const Skills = () => {
    return (
        <div className="section" id="skills">
          <span className="disable-select anchor-tag text-3xl tracking-wider pb-6 text-blue-400">&lt;skills&gt;</span>
          ...
          <span className="disable-select anchor-tag text-3xl tracking-wider pt-6 text-blue-400">&lt;/skills&gt;</span>
        </div>
    )
};
